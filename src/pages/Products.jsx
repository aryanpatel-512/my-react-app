...
/>
      ...
      {/* ── CTA BANNER (FIXED & BULLETPROOF) ── */}
      <section className="cta-banner-v2">
        {/* Layer 1: Solid background */}
        <div className="cta-banner-v2__background" aria-hidden="true" />

        {/* Layer 2: Decorative glow orbs */}
        <div className="cta-banner-v2__glow cta-banner-v2__glow--1" aria-hidden="true" />
        <div className="cta-banner-v2__glow cta-banner-v2__glow--2" aria-hidden="true" />

        {/* Layer 3: Animated particles */}
        <div className="cta-banner-v2__particles" aria-hidden="true">
          {[...Array(12)].map((_, i) => (
            <span key={i} className="cta-banner-v2__particle" />
          ))}
        </div>

        {/* Layer 4: Content (always visible) */}
        <div className="wrap cta-banner-v2__container">
          <div className="cta-banner-v2__content">
            <p className="cta-banner-v2__eyebrow">Need a Custom Solution?</p>
            <h2 className="cta-banner-v2__heading">
              Bulk Orders &amp;
              <br />
              Custom Manufacturing
            </h2>
            <p className="cta-banner-v2__subtitle">
              Get a tailored quote for your hospital, clinic, or healthcare facility.
            </p>
          </div>

          <div className="cta-banner-v2__actions">
            <Link to="/#contact" className="cta-banner-v2__btn cta-banner-v2__btn--primary">
              <span>Request a Quote</span>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path d="M5 12h14M12 5l7 7-7 7" />
              </svg>
            </Link>
            <a href="tel:+919440643193" className="cta-banner-v2__btn cta-banner-v2__btn--secondary">
